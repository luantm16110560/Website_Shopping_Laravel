! function(a) {
    ...
    a.prototype = {
        ...
        initInstragram: function() { dug({ endpoint: "", target: jQuery("#beta-instagram-feed")[0], cacheExpire: 3600, template: '                            <a href="{{link}}" target="_blank">                  <img src="{{images.low_resolution.url}}">                </a>            {{/data}}' }) },
