...
<div class="inner-header">
  ...
  <h3 style="text-align: center">{{$loai_sp->name}}</h3>  
                    ...
                    <ul class="nav navbar-nav navbar-right">
                      <li>
                          <div class="dropdown" style="margin-top: 15px">
                              ...
                              <li><a href="{{route('type_desc',$loai_sp->id)}}">Từ cao đến thấp</a></li>
                              <li><a href="{{route('type_asc',$loai_sp->id)}}">Từ thấp đến cao</a></li>
                ...
                <div class="col-xs-4">
                  <div class="single-item"  style="max-width: 275px">
                    ...
                    <div class="single-item-header">
                      <a href="{{route('product-detail',$product->id)}}"><img  class="img-responsive" src="source/image/product/{{$product->image}}" alt="" height="270px"width="100%"></a>
                    </div>
            ...
            <div class="row">
                ...
                <div class="col-sm-4">
                  ...
                  <div class="single-item" style="max-width: 275px">
                      ...
                      @endif
                    <div class="single-item-header" style="height:270px;width:auto">
                      <a href="{{route('product-detail',$sp->id)}}"><img  style="height:270px;width: 270px" src="source/image/product/{{$sp->image}}" alt="" ></a>
                    </div>
                    <div class="single-item-body">
