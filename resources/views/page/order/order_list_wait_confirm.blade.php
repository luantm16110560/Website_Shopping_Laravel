...
<head>
    ...
    <title>Hóa đơn chờ xác nhận</title>
        ...
        <div class="left">
                ...
                <div class="row">
                    ...
                    <div class="col-md-9">
                            ...
                            <h2 style="text-align: center">Hóa đơn chờ xác nhận</h2>
                            <br>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <div class="col-sm-1">
                                                    ...
                                                    <a href="{{route('order_confirm',['id_bill'=>$b->id])}}" type="submit" class="btn btn-success"><span class="glyphicon glyphicon-ok"></span>
                                                    <a href="{{route('billdetail',['id_bill'=>$b->id])}}" type="button" class="btn btn-primary"><span class="glyphicon glyphicon-eye-open"></span>
                                                    </td>
                                                </div>
                                            </tr>
                                            @endforeach
