    ...
    <div class="left">
        ...
        <div class="row">
            ...
            <div class="col-md-9">
                    ...
                    <h2 id="type" style="text-align: center">Sản phẩm theo danh mục </h2>
                    <br>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                            <div class="col-sm-1">
                                                ...
                                                <div class="col-sm-2">
                                                        <th>
                                                        <img id="myimage" src="source/image/product/{{$p->image}}" style="width:70px;height:70px" />          
                                                        </th>
                                                    </div>
                                                <div class="col-sm-1">
                                                     <th>{{$p->gender}}</th>
...
<script>
    function setTitle()
    {
       // document.getElementById('id_title').value ="asd";
         document.getElementById('type').textContent="Danh mục các sản phẩm {{$p->name_type}}";
    }
</script>
