...
<head>
    ...
    <title>Tìm kiếm hóa đơn theo ngày</title>
        ...
        <div class="left">
                ...
                <div class="row">
                    ...
                    <div class="col-md-9">
                            ...
                            <h2 style="text-align: center">Hóa đơn từ ngày {{Carbon\Carbon::parse($start)->format('d/m/Y')}} đến ngày {{Carbon\Carbon::parse($end)->format('d/m/Y')}} </h2>
                            <br>
