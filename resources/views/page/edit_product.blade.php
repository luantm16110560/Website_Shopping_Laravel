        ...
        <div class="row">
            ...
            <form action="{{route('editproduct',['id_product'=>$p->id])}}" method="post" enctype="multipart/form-data" autocomplete="off">
                    ...
                    <div class="col-sm-4">
                        ...
                        <div class="col-sm-3">
                            <div>
                                ...
                                <img src="source/image/product/{{$p->img1}}" id="output_image" style="width:95px;height:95px" />
                        ...
                        <div class="col-sm-3">
                            ...
                            <div>
                                <img src="source/image/product/{{$p->img2}}" id="myid" style="width:95px;height:95px" />
                    ...
                    <div class="col-sm-8">
                        ...
                        <div class="col-sm-7" style="margin-top: 5px">
                            <label>Size</label>
                        <input type="number" name="size" min=35 max=43 value="{{$p->size}}" required>
